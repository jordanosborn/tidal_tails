...
\\
\\
The aim of this program was to find out how the direction of rotation of the test particle's initial orbits affect the formation of tidal tails for various perturbing galaxies.
...
\\
\\
Note screenshots are automatically taken every 5.0s (simulated system time). 
\\
\\
