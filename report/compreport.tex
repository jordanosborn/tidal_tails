...
\begin{subfigure}{.5\textwidth}
  ...
  \label{fig2:sfig6}
\end{subfigure}
\caption{Plots at 6 different time slices for a perturbing galaxy with a parabolic orbit (e = 1). The perturbing galaxy has a closest approach of 2 units and starts at an angle of $0.35 \times 2\pi$. Test particles are initially in an anticlockwise circular orbit around the central mass. (Perturbation direction set to 1)}
\label{fig2:fig2}
\end{figure}
\clearpage
...
\begin{subfigure}{.5\textwidth}
  ...
  \label{fig3:sfig6}
\end{subfigure}
\caption{Plots at 6 different time slices for a perturbing galaxy with a parabolic orbit (e = 1). The perturbing galaxy has a closest approach of 6 units and starts at an angle of $0.2 \times 2\pi$. Test particles are initially in a clockwise circular orbit around the central mass. (Perturbation direction set to 1)}
\label{fig3:fig3}
\end{figure}
\clearpage
...
\begin{subfigure}{.5\textwidth}
  ...
  \label{fig4:sfig6}
\end{subfigure}
\caption{Plots at 6 different time slices for a perturbing galaxy with a parabolic orbit (e = 1). The perturbing galaxy has a closest approach of 6 units and starts at an angle of $0.2 \times 2\pi$. Test particles are initially in an anticlockwise circular orbit around the central mass. (Perturbation direction set to 1)}
\label{fig4:fig4}
\end{figure}
\clearpage
...
\begin{subfigure}{.5\textwidth}
  ...
  \caption{t = 40.0s, Scale = 30 x 30 square units.}
  \label{fig5:sfig4}
\end{subfigure}
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.8\linewidth]{{../output/e-rmin-theta0-rot-1-10-0.2--1/screenshot-50.00_(-15.00_15.00)(-15.00_15.00)}.png}
  \caption{t = 50.0s, Scale = 30 x 30 square units.}
  \label{fig5:sfig5}
\end{subfigure}
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.8\linewidth]{{../output/e-rmin-theta0-rot-1-10-0.2--1/screenshot-60.00_(-15.00_15.00)(-15.00_15.00)}.png}
  \caption{t = 60.0s, Scale = 30 x 30 square units.}
  \label{fig5:sfig6}
\end{subfigure}
\caption{Plots at 6 different time slices for a perturbing galaxy with a parabolic orbit (e = 1). The perturbing galaxy has a closest approach of 10 units and starts at an angle of $0.2 \times 2\pi$. Test particles are initially in a clockwise circular orbit around the central mass. (Perturbation direction set to 1)}
\label{fig5:fig5}
\end{figure}
\clearpage
...
\begin{subfigure}{.5\textwidth}
  ...
  \label{fig6:sfig6}
\end{subfigure}
\caption{Plots at 6 different time slices for a perturbing galaxy with a parabolic orbit (e = 1). The perturbing galaxy has a closest approach of 10 units and starts at an angle of $0.2 \times 2\pi$. Test particles are initially in an anticlockwise circular orbit around the central mass. (Perturbation direction set to 1)}
\label{fig6:fig6}
\end{figure}
\clearpage
...
\begin{subfigure}{.5\textwidth}
  ...
  \caption{t = 45.0s, Scale = 30 x 30 square units.}
  \label{fig7:sfig3}
\end{subfigure}
\begin{subfigure}{.5\textwidth}
  \centering
...
\begin{subfigure}{.5\textwidth}
  ...
  \caption{t = 75.0s, Scale = 30 x 30 square units.}
  \label{fig7:sfig5}
\end{subfigure}
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.8\linewidth]{{../output/e-rmin-theta0-rot-1-14-0.2--1/screenshot-90.00_(-15.00_15.00)(-15.00_15.00)}.png}
  \caption{t = 90.0s, Scale = 30 x 30 square units.}
  \label{fig7:sfig6}
\end{subfigure}
\caption{Plots at 6 different time slices for a perturbing galaxy with a parabolic orbit (e = 1). The perturbing galaxy has a closest approach of 14 units and starts at an angle of $0.2 \times 2\pi$. Test particles are initially in a clockwise circular orbit around the central mass. (Perturbation direction set to 1)}
\label{fig7:fig7}
\end{figure}
\clearpage
...
\begin{subfigure}{.5\textwidth}
  ...
  \label{fig8:sfig6}
\end{subfigure}
\caption{Plots at 6 different time slices for a perturbing galaxy with a parabolic orbit (e = 1). The perturbing galaxy has a closest approach of 14 units and starts at an angle of $0.2 \times 2\pi$. Test particles are initially in an anticlockwise circular orbit around the central mass. (Perturbation direction set to 1)}
\label{fig8:fig8}
\end{figure}
\clearpage
...
\begin{subfigure}{.5\textwidth}
  ...
  \label{fig9:sfig6}
\end{subfigure}
\caption{Plots at 6 different time slices for a perturbing galaxy with a parabolic orbit (e = 1). The perturbing galaxy has a closest approach of 18 units and starts at an angle of $0.2 \times 2\pi$. Test particles are initially in an anticlockwise circular orbit around the central mass. (Perturbation direction set to 1)}
\label{fig9:fig9}
\end{figure}
\clearpage
